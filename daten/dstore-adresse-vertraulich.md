...
kontext:
  rolle: variante
  variante-von: dstore-adresse
  bedingung: verfahren-vertraulich
  stufe-basis: B
  stufe-variante: D
  zusatzfeld: Vermerk ueber Auskunftssperre
...
# Anschrift von Personen in Verfahren, deren Zugehörigkeit selbst schutzbedürftig ist, einsc

## Definition

Anschrift von Personen in Verfahren, deren Zugehörigkeit selbst schutzbedürftig ist, einschließlich der Anschrift von Unterkünften und Einrichtungen.

## Felder

- Straße und Hausnummer
- Postleitzahl und Ort
- Art der Unterkunft, soweit erfasst
- abweichende Zustellanschrift
- Vermerk über Auskunftssperre oder bedingten Sperrvermerk

## Abgrenzung zu `dstore-adresse`

**Die Datenart ist dieselbe. Der Unterschied liegt darin, worüber ihre Existenz Auskunft gibt.**

`dstore-adresse` steht in Verfahren, deren Zugehörigkeit für die betroffene Person nicht belastend
ist -- eine Gewerbeanmeldung, ein Bauantrag, eine Ummeldung, eine Wahlbenachrichtigung. Dort
ist der Name ein Name.

Dieser Speicher steht in den 8 Verfahren, bei denen **die bloße Tatsache der Zugehörigkeit
...
**Die Anschrift ist in diesen Verfahren mehr als ein Zustellweg.** Die Adresse einer Gemeinschaftsunterkunft, einer sozialpsychiatrischen Einrichtung oder einer Wohnung, in der ein Kind nach § 42 SGB VIII untergebracht ist, sagt für sich genommen alles Wesentliche.

Deshalb gehört hierher der Vermerk über eine Auskunftssperre nach § 51 BMG. Er ist redundant zu `dstore-auskunftssperre-melderegister` -- und das ist beabsichtigt: Die Prüfung muss dort stattfinden, wo die Adresse verwendet wird, nicht nur dort, wo sie geführt wird.

## Hinweise

Angelegt am 2026-08-10 bei der Aufspaltung der Allgemeinplätze. Die Durchsicht hatte gezeigt,
dass `dstore-adresse` über 13 Organisationseinheiten streut und deshalb keine einheitliche
