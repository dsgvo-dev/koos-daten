...
kontext:
  rolle: variante
  variante-von: dstore-personenstammdaten
...
# Identifikations- und Zuordnungsdaten natürlicher Personen in Verfahren, deren Zugehörigkei

## Definition

Identifikations- und Zuordnungsdaten natürlicher Personen in Verfahren, deren Zugehörigkeit selbst schutzbedürftig ist. Inhaltlich identisch mit den allgemeinen Personenstammdaten.
...
## Abgrenzung zu `dstore-personenstammdaten`

**Die Datenart ist dieselbe. Der Unterschied liegt darin, worüber ihre Existenz Auskunft gibt.**

`dstore-personenstammdaten` steht in Verfahren, deren Zugehörigkeit für die betroffene Person nicht belastend
ist -- eine Gewerbeanmeldung, ein Bauantrag, eine Ummeldung, eine Wahlbenachrichtigung. Dort
ist der Name ein Name.

Dieser Speicher steht in den 59 Verfahren, bei denen **die bloße Tatsache der Zugehörigkeit
...
**Der Prüfstein ist die Aktenzeichenlogik.** Trägt ein Vorgang ein Aktenzeichen, aus dessen Aufbau das Fachverfahren ablesbar ist, wandert die Information mit jedem Umschlag, jeder Betreffzeile und jedem Verteiler mit. Deshalb gehört das Aktenzeichen hier ausdrücklich zu den Feldern -- es ist kein technisches Beiwerk, sondern der häufigste Weg, auf dem die Verfahrenszugehörigkeit nach außen gelangt.

## Hinweise

Angelegt am 2026-08-10 bei der Aufspaltung der Allgemeinplätze. Die Durchsicht hatte gezeigt,
dass `dstore-personenstammdaten` über 33 Organisationseinheiten streut und deshalb keine einheitliche
