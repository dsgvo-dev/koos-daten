...
(3) **Gebührendaten** sind personenbezogene Daten, die zur Gebührenermittlung und Gebührenabrechnung erforderlich sind: Nebenstelle, Beginn, Ende, Dauer, Datum, Uhrzeit, verkürzte Zielnummer, Gebühreneinheiten.

(4) **Inhaltsdaten** sind die zwischen den Teilnehmern ausgetauschten Informationen (das gesprochene Wort).
...
(5) Das Aufschalten auf laufende Telefongespräche ist nur dann zulässig, wenn eine dringende Mitteilung weitergegeben werden muss und die Gesprächspartner durch ein Signal über die Aufschaltung informiert werden. Das Aufschalten ist nur durch Beschäftigte der Telefonzentrale zulässig.
...
g) Art der Verbindung (direkt, umgeleitet, Konferenz).

(3) Von internen Telefongesprächen (innerhalb der Telekommunikationsanlage) erfolgen keinerlei Aufzeichnungen von Verbindungsdaten.
...
(2) Wartungsarbeiten werden nur von Mitarbeitern des IT-Bereichs oder von gesondert verpflichtetem Personal der zuständigen Wartungsfirma durchgeführt. Die Wartungsarbeiten sind durch Serviceberichte zu dokumentieren.
...
| Leistungsmerkmal | Beschreibung | Aktiviert |
|-----------------|-------------|-----------|
| Identifizieren | Anzeige des Anrufers im Display | Ja |
| Freisprechen/Lauthören | Gespräch über Lautsprecher führen | Ja |
| Rückruf | Automatischer Rückruf bei besetzt | Ja |
| Anrufumleitung | Weiterschaltung an anderen Anschluss | Auf Antrag |
| Wahlwiederholung | Letzte Rufnummer erneut anwählen | Ja |
| Konferenz | Drei oder mehr Teilnehmer zusammenschalten | Auf Antrag |
