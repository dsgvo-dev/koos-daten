...
- Personalrat (im Rahmen seiner Beteiligungsrechte)
- Beschaffungsstelle / Vergabestelle
- Alle Beschäftigten als zukünftige Nutzerinnen und Nutzer
...
| Begriff | Definition |
|---------|------------|
| **IT-Verfahren** | Software, Fachverfahren, digitale Arbeitsmittel und IT-gestützte Prozesse |
| **Einführung** | Erstmaliger Einsatz eines IT-Verfahrens in der Verwaltung |
| **Wesentliche Änderung** | Änderung mit Auswirkung auf Datenverarbeitung, Sicherheit oder Verarbeitungszwecke |
| **Fachverantwortliche/r** | Leitung der Organisationseinheit, die das Verfahren einführen will |
...
Phase 1: Bedarfsmeldung und Antrag
    ↓
Phase 2: Datenschutz- und Sicherheitsprüfung
    ↓
...
- Voraussichtliche Anzahl der Nutzerinnen und Nutzer
- Geplanter Termin der Einführung
- Angabe, ob das Verfahren bei einem externen Dienstleister betrieben wird

(2) Der Antrag ist der IT-Abteilung und dem/der DSB vorzulegen.

### Phase 2 — Datenschutz- und Sicherheitsprüfung

(1) Die IT-Abteilung prüft das Verfahren technisch:

- Integration in die bestehende IT-Infrastruktur
- Erforderliche Schnittstellen zu anderen Systemen
- Kompatibilität mit bestehenden Sicherheitsstandards
- Erforderliche Hard- und Software-Ressourcen

(2) Der/Die DSB prüft:

- Erforderlichkeit einer Datenschutz-Folgenabschätzung nach Art. 35 DSGVO
- Bei hohem Risiko: Durchführung der DSFA vor der Einführung
- Eintragungspflicht im Verzeichnis der Verarbeitungstätigkeiten (Art. 30 DSGVO)
- Notwendigkeit eines Auftragsverarbeitungsvertrags nach Art. 28 DSGVO
- Privacy by Design / Privacy by Default (Art. 25 DSGVO)

(3) Der/Die ISB prüft:

- Angemessenheit der technisch-organisatorischen Maßnahmen nach Art. 32 DSGVO
- Schutzbedarf des Verfahrens (normal / hoch)
...
- Zugriff auf welche Daten/Funktionen
- [verfahrensspezifisch ergänzen]

**b) Nutzerbezogene Inhaltsdaten:**

- [verfahrensspezifisch: Name, Vorname, E-Mail, Telefonnummer,
  Fachdaten, …]

(2) Die Nutzung der Protokolleinträge und Inhaltsdaten ist zulässig:
...
- Umgang mit personenbezogenen Daten im Verfahren
- Verhalten bei Störungen und Sicherheitsvorfällen

(2) Die Schulungen sind zu dokumentieren (Teilnehmer, Datum, Inhalte).
...
(1) Verstöße gegen diese Dienstanweisung können je nach Schwere

- arbeitsrechtliche,
- disziplinarrechtliche oder
...
| Anlage | Inhalt | Verantwortlich |
|--------|--------|----------------|
| A | Antragsformular IT-Einführung | Fachverantwortliche/r |
| B | Berechtigungskonzept (Rechte- und Rollenmatrix) | IT-Abteilung |
| C | Schnittstellen-Dokumentation | IT-Abteilung |
| D | AVV / Vertrag Auftragsverarbeitung (Art. 28 DSGVO) | Fachverantwortliche/r + DSB |
